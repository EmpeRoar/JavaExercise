...
public class MessagePanel extends JPanel {
	...
	public MessagePanel() {
		...
		treeCellRenderer.setLeafIcon(Utils.createIcon("/images/Server24.gif"));
		treeCellRenderer.setOpenIcon(Utils.createIcon("/images/WebComponent24.gif"));
		treeCellRenderer.setClosedIcon(Utils.createIcon("/images/WebComponentAdd24.gif"));
	...
	private DefaultMutableTreeNode createTree() {
		...
		DefaultMutableTreeNode server5 = new DefaultMutableTreeNode(new ServerInfo("Edinburg", 5));
		branch2.add(server4);
		branch2.add(server5);
